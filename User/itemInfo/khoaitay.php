...
<body>
    ...
    <div class="item-container">
        <img class="fruit-img" src="../img/khoaitay.jpg" alt="khoaitay">
        <div class="item-info">
            <p>
                Tên: Khoai tây<br>
                Xuất xứ: Tây Nguyên <br>
                Ngày nhập kho: 14/11/2024<br>
                HSD: 1 tuần đến vài tháng sau ngày nhập kho<br>
                Giá: 31.000đ/kg<br>
            </p>
    ...
    <div style="max-width: 1500px; overflow: hidden; margin: auto;  margin-top: 100px;">  
        <img src="../img/banner-quang-cao.webp" alt="banner-quang-cao" style="width: 100%; height: 400px; display: block;">  
    </div>
            ...
            <div class="col l-3 m-6 c-12">
                ...
                <div>
                    <ul >
                        ...
                        <li class="li_menu"><a href="../user/introducelogin.html"style="text-decoration: none;color: #333;">Giới thiệu</a></li>
                        
                        <li class="li_menu"><a href="../user/newslogin.html"style="text-decoration: none;color: #333;">Tin tức</a></li>
                        
                        <li class="li_menu"><a href="../user/contactlogin.html"style="text-decoration: none;color: #333;">Liên hệ</a></li>
