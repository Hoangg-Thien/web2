    ...
    <div id="searchModal" class="modal" style="display:none;">
        <div class="modal-content">
            ...
            <div class="auth-buttons">  
                <a href="./regis.php" title="Đăng ký" target="_blank">Đăng ký</a>  
                <span>|</span>  
                <a href="./login-user.php" title="Đăng nhập" target="_blank">Đăng nhập</a>  
            </div> 
        </div>  
    </div> 
...
$sql = "SELECT * FROM sanpham WHERE hidden = 0";
...
if (!empty($priceRange) && strpos($priceRange, '-') !== false) {
    ...
    $min = (int)$min * 1000;
    $max = (int)$max * 1000;
    $sql .= " AND product_price BETWEEN $min AND $max";
}
