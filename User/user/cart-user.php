        ...
        <section class="breadcrumb_section container">  
            <nav aria-label="breadcrumb">  
                <div class="breadcrumb">  
                    ...
                    <div style="padding: 10px;">  
                        <a href="../user/cart-user.php" style="text-decoration: none; color: #ccc;"> Giỏ hàng</a>  
                    </div>  
                </div>  
        ...
        <div class="modal-dialog" role="document">  
            <div class="modal-content">  
                ...
                <div class="modal-footer">  
                    ...
                    <button type="button" class="btn btn-primary" onclick="location.href='payment-user.php'">Thanh toán</button>  
                </div>  
            </div>  
        </div>    
    </div>  
