...
<body>  
    ...
    <div class="grid wide">
        ...
        <div class="cart-container" style="padding: 30px;min-height: 500; max-width: 900px; margin: 40px auto; background: #fff; border-radius: 12px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
