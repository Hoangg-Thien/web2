        ...
        <div style="display: flex; align-items: center; padding: 10px 20px;">  
            <div class="product-category">DANH MỤC SẢN PHẨM
                <ul>
                    ...
                    <li><a href="../user/vegetables-nologin.php">Rau củ  </a></li>
                    <li><a href="../user/dried-fruits-nologin.php">Trái cây Khô</a></li>
                    <li><a href="../user/nut-fruits-nologin.php">Các loại hạt  </a></li>
                </ul>
            </div>  
            <div class="menu">  
