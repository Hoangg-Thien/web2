            ...
            <div class="news-grid">
                ...
                <div class="news-card">
                    ...
                    <div class="news-content">
                        <h2 class="news-card-title">Cherry Mỹ - Nữ hoàng của các loại trái cây nhập khẩu</h2>
                        <p class="news-excerpt">Khám phá hương vị ngọt ngào và lợi ích sức khỏe tuyệt vời từ Cherry Mỹ cao cấp</p>
                        <div class="news-meta">
                ...
                <div class="news-card">
                    <div class="news-image">
                        <img src="../img/trai-le.png" alt="Lê Nam Phi">
                    </div>
                    <div class="news-content">
                        <h2 class="news-card-title">Lê Nam Phi - Hương vị tinh tế từ châu Phi</h2>
                        <p class="news-excerpt">Lê Nam Phi với vẻ ngoài sang trọng và hương vị độc đáo đang được ưa chuộng trên thị trường</p>
                        <div class="news-meta">
                            <span class="news-category">Trái Cây Nhập Khẩu</span>
                            <span class="news-date">27/04/2025</span>
                        </div>
                ...
                <div class="news-card">
                    <div class="news-image">
                        <img src="../img/trai-viet-quat.jpg" alt="Việt quất">
                    </div>
                    <div class="news-content">
                        <h2 class="news-card-title">Việt Quất Chile - Siêu thực phẩm từ Nam Mỹ</h2>
                        <p class="news-excerpt">Việt quất Chile với hàm lượng chất chống oxy hóa cao nhất trong các loại trái cây đang được săn đón</p>
                        <div class="news-meta">
                            <span class="news-category">Trái Cây Nhập Khẩu</span>
                            <span class="news-date">27/04/2025</span>
                        </div>
