...
<body>
    ...
    <script> 
        ...
        if (confirm("Bạn có chắc muốn thêm sản phẩm này vào giỏ hàng khô
            addToCart(productId);
        }
    }
...
document.querySelector('.dropdown-button').addEventListener('click', fun
    ...
    document.getElementById("toggleSearch").addEventListener("click", fu
