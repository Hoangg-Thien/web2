    ...
    <body>  
            ...
            <div style="display: flex; align-items: center; padding: 10px 20px;">  
                <div class="product-category">DANH MỤC SẢN PHẨM
                    <ul>
                        ...
                        <li><a href="./Imported-fruits-nologin.php">Trái cây Khô</a></li>
                        <li><a href="./Imported-fruits-nologin.php">Các loại hạt </a></li>
                    </ul>
                </div>  
                <div class="menu">  
                    <a href="../user/usernologin.php" class="active">Trang chủ</a>  
        ...
        <div >    
            ...
            <div class="product-container">
                ...
                while($row = $result->fetch_assoc()) {
                    $product_link = "product_detail.php?id=" . $row['product_id'];
                ?>
                    <div class="product-card">
                        ...
                        <div class="product-info">
                            ...
                            <p class="product-price"><?php echo number_format($row['product_price'], 0, ',', '.'); ?> VND</p>
                            <div class="product-actions">
                                <a href="<?php echo $product_link; ?>" class="view-details" title="Xem chi tiết">
                                    <i class="fas fa-info-circle"></i>
                                </a>
                                <button class="add-to-cart" onclick="confirmAddToCart('<?php echo $row['product_id']; ?>')" title="Thêm vào giỏ hàng">
        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <ul>
                    <li><a href="./usernologin.php">Trang chủ</a></li>
